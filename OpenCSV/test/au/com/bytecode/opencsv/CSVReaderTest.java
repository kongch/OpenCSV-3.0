...
public class CSVReaderTest {
    ...
    public void testSpacesAtEndOfString() throws IOException {
        ...
        CSVReader c = new CSVReader(new StringReader(sb.toString()), Constants.DEFAULT_SEPARATOR, Constants.DEFAULT_QUOTE_CHARACTER, true);
     ...
     */
    @Test
    public void testQuoteWhenDoubleQuoteIsQuoteChar() throws IOException {

        StringBuilder sb = new StringBuilder(CSVParser.INITIAL_READ_SIZE);

        sb.append("a,\"\",\"c\"\"\"\"d\"e\"").append("\n");// a,'',c
     ...
     */
    @Test
    public void testRestrictQuotedParsedLine() throws IOException {
    ...
    public void quoteAndEscapeMustBeDifferent() {
        ...
        new CSVReader(new StringReader(sb.toString()), Constants.DEFAULT_SEPARATOR, Constants.DEFAULT_QUOTE_CHARACTER, Constants.DEFAULT_QUOTE_CHARACTER, CSVReader.DEFAULT_SKIP_LINES, CSVParser.DEFAULT_STRICT_QUOTES, CSVParser.DEFAULT_IGNORE_LEADING_WHITESPACE);
    ...
    public void separatorAndEscapeMustBeDifferent() {
        ...
        new CSVReader(new StringReader(sb.toString()), Constants.DEFAULT_SEPARATOR, Constants.DEFAULT_QUOTE_CHARACTER, Constants.DEFAULT_SEPARATOR, CSVReader.DEFAULT_SKIP_LINES, CSVParser.DEFAULT_STRICT_QUOTES, CSVParser.DEFAULT_IGNORE_LEADING_WHITESPACE);
    }
    ...
    public void separatorAndQuoteMustBeDifferent() {
        ...
        new CSVReader(new StringReader(sb.toString()), Constants.DEFAULT_SEPARATOR, Constants.DEFAULT_SEPARATOR, Constants.DEFAULT_ESCAPE_CHARACTER, CSVReader.DEFAULT_SKIP_LINES, CSVParser.DEFAULT_STRICT_QUOTES, CSVParser.DEFAULT_IGNORE_LEADING_WHITESPACE);
    }
